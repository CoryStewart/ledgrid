...
if __name__ == '__main__':
    ...
    if True:        
        ...
        seq3.addFrame( frogger_ss, 'alligator_headopen', duration_ms=dur )
        ...
        seq3.addFrame( frogger_ss, 'FrogStanding1', duration_ms=dur )
        seq3.addFrame( frogger_ss, 'FrogStanding2', duration_ms=dur )
        seq3.addFrame( frogger_ss, 'FrogSplat1', duration_ms=dur )
        seq3.addFrame( frogger_ss, 'FrogSplat2', duration_ms=dur )
